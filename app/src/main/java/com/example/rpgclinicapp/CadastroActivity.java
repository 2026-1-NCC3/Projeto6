...
public class CadastroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.widget.CheckBox cbLgpd = findViewById(R.id.cb_lgpd);
        ...
        btnCadastrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cbLgpd.isChecked()) {
                    Toast.makeText(CadastroActivity.this, "Você precisa aceitar os termos da LGPD para criar a conta.", Toast.LENGTH_LONG).show();
                    return;
                }
